...
Even though you have control over what you choose to do, you may find yourself in the puzzling position of regretting the decisions of your prior self.

For instance, if you need to lose weight but you bust your calorie budget with that extra piece of cake, you appear to be knowingly acting against your own “better judgment.”

为什么控制自己这么难？

即使你能控制你选择的东西，**你有时也会陷入一种令人困惑的处境，即对违背了之前的决定而感到后悔。**
===长句要拆开翻译===

例如说，如果你需要减肥，但是你多吃了一块蛋糕，导致你的卡路里摄入量超标，这就**明知故犯**地违背了你自己的更好的判断。

---

In this case, better judgment captures the tension between the preferences of your present self and your future self.

Following your better judgment in any one moment rests on your will.

Fortunately, will seems to depend on environment, bodily state and mental state – all of which you can influence.

在这种情况下，“更好判断”描述了当下的自己和未来的自己之间的偏好的**紧张关系**。

在任何时刻遵循你的最佳判断，取决于你的意志力。

幸运的是，意志力似乎取决于环境、身体状态还有心理状态，而这些你都可以去主动影响。

---


*This article presents two complementary models of “will” as it relates to enhancing self-control:*

1. an abstract psychological model that breaks down will into willpower and “willenergy”; and
2. a neurobiological model that looks at will throught the lens of neurotransmission.

The goal is to provide effective techniques that lead to higher self-control.

I’m also coining the term willenergy so that I can define another important concept: willenergy bankruptcy.

Many struggling with self-control are in an unrecognized **crisis state**, and they must declare “willenergy bankruptcy” to break themselves out of a vicious cycle.


这篇文章提供了2种关于意志力的基础模型，涉及到如何增强自控力：

1. 一个抽象的心理学模型，把意志力分为意志强度和意志能量；
2. 一个神经生物学模型，从神经冲动的**角度**看待意志力。

目的是提供增强自控力的有效手段。

我还引入了这个概念：**意志能量**，因而我可以定义另一个重要的概念：**意志能量仓库**。

许多挣扎于自控的人处于一种未识别的关键状态，他们必须声明意志能量仓库，以打破他们的恶性循环。
...
In fact, much of my advice here reflects the “[Least Resistance Philosophy](https://matt.might.net/articles/productivity-tips-hints-hacks-tricks-for-grad-students-academics/)” that I’ve written about since 2009:
...
- [Least-resistance productivity](https://matt.might.net/articles/productivity-tips-hints-hacks-tricks-for-grad-students-academics/)
- [Least-resistance weight loss](https://matt.might.net/articles/least-resistance-weight-loss/)
- [Least-resistance strength training](https://matt.might.net/articles/hacking-strength/)
...
结果就是，你需要设计**生活方式**，来减少对自控力的**主动消耗**。

事实上，许多我的建议是来自我2009年开始写的文章“最小阻力原则”。

>改变你的环境，让你的最小阻力路径就是最大生产力路径。

如果你喜欢这篇文章，你也许还会喜欢这个最小阻力系列的其他文章：
- 最小阻力生产力
- 最小阻力减肥
- 最小阻力力量训练

我还推荐James Clear写的《原子习惯》，他将这个方法用到了极致。
...
There is a paradox embedded in the notion of self-control: if your self is not what is controlling your actions, then what _is_?

At first glance, you seem to be in _total_ control of your self.

You _choose_ to do homework or watch TV.

You _choose_ to abstain from eating or eat candy.
...
在自控力的内涵里有一个悖论：如果你控制你行为的并不是你自己，那么是什么？

第一个念头，你似乎对自己有*完全*的控制权。
...
然而如果你控制着你的行为，为什么你常常对能预见结果的选择感到后悔？

---

Whenever you fail to do what you think you _should_ do, you are experiencing what philosophers called _akrasia_.
...
In fact, according to the Oxford dictionary, _akrasia_ is
...
尽管你可以控制自己选择做什么，但你可能会发现自己处于一种令人困惑的境地：后悔自己之前的决定。

例如，如果你需要减肥，却因为多吃了一块蛋糕而超出了卡路里预算，你看起来就像是在明知故跑地违背自己的“理智判断”。

在这种情况下，理智判断捕捉到了你“现在的自我”与“未来的自我”偏好之间的紧张关系。在任何时刻遵循你的理智判断都取决于你的**意志**（will）。

幸运的是，意志似乎取决于环境、身体状态和心理状态——所有这些都是你可以影响的。
...
我还创造了“意志能量”（willenergy）这个词，以便定义另一个重要概念：“意志能量破产”（willenergy bankruptcy）。许多在自控力中挣扎的人正处于一种未被察觉的危机状态，他们必须宣布“意志能量破产”才能打破恶性循环。

#### **核心要点：不要依赖自控力**

本文的核心要点是：**自控力必须像一种有限、稀缺的资源一样被管理。**

因此，你需要进行生活方式设计，以尽量减少对自控力的主动消耗。

事实上，我在这里的大部分建议都反映了我自2009年以来一直在写的“最小阻力哲学”：塑造你的环境，使**阻力最小的路径成为生产力最高的路径**。
...
通过自控力的“缺失”来定义自控力是最容易的。

自控力的概念中蕴含着一个悖论：如果不是你的“自我”在控制你的行动，那么是谁在控制？

乍一看，你似乎完全控制着自己。你选择做作业或看电视；你选择不吃东西或吃糖果；你选择躺在床上或出去跑步。

然而，如果你控制着自己的行为，为什么对那些结果可预见的抉择感到后悔会如此频繁地发生？

每当你未能做你认为你应该做的事情时，你就在经历哲学家所说的“意志薄弱”（**akrasia**）。

Akrasia 是思考自控力含义的一种实用方式：如果我们自控力高，我们经历的 akrasia 就少；如果我们自控力低，经历的 akrasia 就多。从实践层面讲，提高自控力就是尽量减少 akrasia。

关于人类为何会产生这种行为的理论可以追溯到几千年前。一些早期的哲学家（以及一些现代的非哲学家）甚至认为 akrasia 是不可能的：在他们看来，如果你做了某件事，那么做那件事就是你真实的理性偏好。

不幸的是，通过定义让 akrasia 消失并不能消除“可预见的后悔”。以可预见的后悔作为衡量标准，akrasia 随处可见：成瘾、过量饮食、拖延和睡眠不足都是其实例。

直觉告诉我们，我们之所以产生这些行为是因为缺乏“意志”。

事实上，根据牛津词典的定义，akrasia 是：

> 一个人因意志薄弱而违背其理智判断的心智状态。

更强的意志会导致行为与理智判断更加一致。但是，意志究竟是什么？

#### **意志的抽象模型**

为了避免关于意志定义的哲学争论，我将坚持把问题重新定义为：如何最小化 akrasia。

也就是说，我们试图最小化“我们觉得应该做的”与“我们实际做的”之间的差距。

根据 akrasia 的定义，“意志”就是解释这一差距的任何东西。我们可以通过经历的可预见后悔的数量来衡量 akrasia。
...
更重要的是，当你开始尝试自控时，你可以使用这些相同的指标来弄清楚什么对你有效，什么无效。

对于自控力研究的通俗回顾，我强烈推荐 Baumeister 和 Tierney 合著的《意志力》（_Willpower_）。

借鉴该书中的研究，我将描述一个包含两个元素的相对简单的意志模型：(1) **意志力**（willpower）和 (2) **意志能量**（willenergy）。

在目前的用法中，“willpower”似乎同时指代这两个概念，但将它们分开是有价值的。

#### **什么是意志力？**

**意志力**是在面对特定厌恶时采取行动，或在面对特定冲动时不采取行动的能力。

冲动或厌恶越强，克服它们所需的意志力就越高。

例如，拒绝一碗西蓝花比拒绝一碗冰淇淋所需的意志力要少。

在研究中，意志力被比作肌肉：它有一个最大的发力极限。试图超越这个极限去压制冲动或厌恶会导致“意志力失效”：我们会做出那种明明知道未来自我会后悔的行为。

例如，如果你明天早上要交一份报告，但你却熬夜在 Netflix 上刷剧，你知道明天早上你会后悔。在这种情况下，看 Netflix 的冲动加上对工作的厌恶，强度超过了你当时的意志力极限。

这个定义也为如何提高自控力提供了第一个启示：

假设你在咖啡馆而不是家里工作。假设你没带耳机。现在你没法看 Netflix 了。于是，你的意志力只需要克服对工作的厌恶，而不需要同时对抗看 Netflix 的诱惑。

#### **什么是意志能量？**

在肌肉类比下，意志力似乎也会随着每次使用而减弱。

反复的发力开始限制总的最大发力能力。最终，将无法再施加任何意志力。

我们可以合理地称这种稀缺资源为**意志能量**（willenergy）。

对于意志力来说，即使是像“忍住不吃诱人零食”这样看似微不足道的事情，也会消耗这种资源。做决定——无论是被动还是主动——似乎都会耗尽这一储备。

意志能量的耗尽会导致“决策疲劳”，即我们决策的质量、甚至做出决策的能力都会随着意志力的反复使用而退化。

例如，在漫长的一天工作后，瘫在沙发上、吃垃圾食品、看电视的诱惑，很容易压倒去锻炼、做营养餐或从事有长期益处的活动的愿望。

#### **意志力与意志能量如何关联？**

你可以把意志能量想象成智能手机的电池。

就像不同的应用程序以不同的速率消耗电池一样，不同的冲动和厌恶也以不同的速率消耗意志能量。

在物理学中，功率（power）是能量在瞬间消耗的速率——单位时间内能量的变化。

类比之下，在这个模型中，我们施加的意志力越多，或持续时间越长，事后剩下的意志能量就越少。当意志能量耗尽时，就无法施加意志力。

作为一个具有可测试预测的模型，我邀请你自己去测试。

#### **意志的神经生物学模型**

“意志 = 意志力 + 意志能量”模型的优点在于，它允许你在日常、人类尺度的语境下，对如何影响和管理你的意志做出预测。

现代神经科学已经开发出复杂的意志模型，通过饱足感、愉悦感、奖励感、动力、专注力和能量感来体现。

神经传递途径驱动了这些感觉，其中三种神经传递特别关键：血清素、多巴胺和肾上腺素途径。

这三种途径都可以被操纵，但**多巴胺途径**对动力尤为重要。

将多巴胺完全等同于动力是简化了问题，特别是考虑到还有其他因素参与动力感的产生，且多巴胺的功能不止于此。

然而，总的来说，多巴胺活动的增加与动力感的增强有关。

虽然神经传递和多巴胺途径的完整科学超出了本文范围，但神经生物学模型为抽象模型提供了一个验证：对于抽象模型的任何预测，我们可以检查它是否对多巴胺活动有已知的影响。

对于神经生物学模型的精彩综述，我推荐 Huberman 教授的播客剧集。

#### **医疗警告**

我提出神经生物学模型的一个原因是：如果你觉得自己的意志力有严重或异常的缺陷，你可能实际上患有“意志缺失症”（aboulia）、非典型抑郁症或动机减退障碍。这些情况需要合格的医疗人员及时的专业诊治。

意志缺失是一些药物的副作用——特别是那些抑制多巴胺活动的药物，如 SSRI 类抗抑郁药或其他多巴胺拮抗剂——因此在调整药物时与专业医生合作至关重要。

#### **你的“应做/不应做”清单**

每个人都有“待办事项”（To-Do）清单系统。如果你认为你没有，那么你的系统可能就是由短期记忆、电子邮箱和散落在环境中需要处理的物体组成的集合。

自控力需要一份额外的清单：你的**“应做/不应做”（Should/Shouldn't Do）清单**。

每个人其实也都有这份清单。默认的那份就是你行动或不行动后的后悔感。就是那种你会说“我明明知道该怎么做，但我还是做了”的后悔。

当然，要进行有意义的自控，你必须梳理出你觉得你应该做的事情，以及你觉得你不应该做的事情。

这份清单让“可预见的后悔”变成了一个可衡量的概念。你可以对照这份清单衡量之前的行为，弄清楚随着时间的推移，你是变得更加还是更少 akratic（意志薄弱）。

一旦你列出了这些事项，你就可以开始制定管理意志力和意志能量的策略，使你的生活向“应做”倾斜，远离“不应做”。

我强烈建议在纸上或手机上保留一份书面清单。

每当你发现自己在想或在说“我应该做 X”、“我本该做 X”或“我不该做 Y”、“我本不该做 Y”时，如果是新内容就添加到清单中，如果是已有的就加一个感叹号。

事实上，如果你读完本文只做这一件事，你会惊讶于自己有多少次在当下给了自己极好的建议，却在随后完全忽视了它。

随着感叹号的累积，这份清单就成了你自控力（或其缺失）的仪表盘，它会告诉你应该把管理意志力和意志能量的重点放在哪里。

#### **破解意志力（Hacking Willpower）**
...
承认处理诱惑的能力有限，这强有力地支持了应避开那些过去意志力不足以提供保障的场景和情况。例如，如果你发现自己在某些餐厅更容易暴饮暴食，那么在节食期间完全不去这些餐厅就从根本上消除了施加意志力的需要。

意志力黑客：通过练习加强

如何增加意志力？也就是说，如何增加你对瞬间冲动或厌恶的最大耐受力？如果肌肉类比成立，那么“渐进超负荷”方法可能对你有效。你可以稳步适应越来越强的诱惑。但要小心，因为选择超过极限的诱惑会导致意志力失效。事实上，更安全的方法是通过克服那些没有实际伤害的厌恶来增强意志力。例如，洗冷水澡是训练意志力的好方法。如果失败了，唯一的伤害只是你没洗成冷水澡。

意志力黑客：奖励自己

如果某件事看起来刚好超出了你的意志力极限，你可以通过为完成目标提供奖励来暂时提高这个极限。例如，告诉自己，如果写一小时报告，就可以看一集喜欢的剧。

意志力黑客：拆解任务

或者，不设奖励，而是将任务拆解成小步骤，使第一步低于极限，这样你就能骗自己开始。例如，与其要求自己写一小时报告，不如要求自己只写一句话。奇怪的是，写完第一句后，你很有可能就有意志力写下一句了。

意志力黑客：让“应做之事”变容易

通常情况下，你觉得应该做的事都是那些“未来获益、当前痛苦”的事。因此，你让这些事做得越容易，它们落在意志力极限内的机会就越大。例如，把健康食品放在柜台上或冰箱最显眼的位置；或者前晚就准备好运动服，把跑鞋放在门口。

意志力黑客：将难事移至意志力高点

在神经生物学模型中，多巴胺在充足睡眠后最高。因此，在早晨第一件事就处理你最畏惧的任务是明智的，因为那时你更有可能有意志力面对它们。最终，这甚至可能需要调整睡眠周期。

意志力黑客：让“不应做之事”变困难

正如应做之事有当前痛苦一样，不应做之事往往有“未来痛苦、当前获益”。因此，你让这些事做得越难，你就有更大的机会凭意志力避开它们。例如，把垃圾食品放在难以拿到的地方，或者根本不买回家。

意志力黑客：利用高意志力时期制约低意志力时期

在《原子习惯》中，James Clear 谈到了“承诺机制”（commitment devices）——允许你利用高意志力时期来制约已知可能意志力低下的时期。这是一个在你当前状态良好时锁定未来自我行为的方法。一个简单的例子是：在你不饿的时候扔掉家里所有的垃圾食品；或者设置路由器/浏览器，在晚上 9 点后屏蔽浪费时间的网站。

#### **破解意志能量（Hacking Willenergy）**

作为稀缺资源，意志能量也需要优化：如何分配这种有限资源以最大化其效用？此外，我们还可以研究如何增加可用的意志能量。

意志能量黑客：避免诱惑

与意志力一样，避免诱惑有助于节省意志能量。即使你有意志力抗拒诱惑，抗拒本身仍在消耗能量。

意志能量黑客：睡眠

意志能量在什么时候补充？睡眠是最重要的方式。从神经生物学角度看，多巴胺在睡醒后最高，并随着清醒时间的增加而减少。每个人都熟悉疲劳对决策的负面影响。充足且高质量的睡眠是提升意志能量储备最简单的方法之一。

意志能量黑客：饮食

均衡饮食对于维持意志能量的稳定至关重要。不平衡、高糖的饮食会导致多巴胺飙升后骤降，导致意志能量全天波动。

意志能量黑客：运动

有些矛盾的是，运动能提升意志能量。虽然运动会消耗体力，但它通过调节神经传递来增加动力。我采取了一种极端的方法，结合了走步机和电动升降桌，使我能整天边工作边进行低强度运动。

意志能量黑客：自动化

任何可以自动化的常规任务都应该自动化，这样它就不再消耗意志能量。自动化大量的小任务也会产生显著影响。

意志能量黑客：养成习惯

对于需要人类智能的任务，任何能转化为习惯的事情都不会消耗意志能量，因为决策和执行发生在意识阈值之下。

#### **意志能量破产：意志耗尽的恶性循环**

提升意志能量的技术往往本身就需要少量的意志力。例如，健康饮食、充足睡眠和规律运动。虽然这些行为产生的能量多于消耗，但如果你达到了“意志能量零点”，维持这些习惯就会变得困难。

结果是，你每天的意志能量起始储备越来越低。这使得获得良好睡眠、营养和运动变得更难。这种恶性循环会导致职业倦怠、无助感和失去掌控感。

如果你发现自己意志能量完全枯竭，可能是时候宣布“**意志能量破产**”了。

在财务破产中，可以重组债务；在意志能量破产中，你有单方面的权力去重组并丢弃负担，从而腾出时间去吃饭、睡觉和运动。

例如，你可以把收件箱里的所有邮件移到一个标有“意志能量破产”的文件夹里。一旦你重新建立了良性循环，意志能量稳步回升，你就可以再考虑用盈余去处理那些遗留的事项。

#### **告诫：自控力 vs. 行为改变**

本文重点讨论的是选择瞬间的自控力。

自控力是更广泛的行为改变过程中的关键因素。但自控力并不是唯一的因素。

事实上，我希望这篇文章间接地解释了为什么在面对成瘾、习惯养成或更广泛的行为改变时，仅仅依赖自控力是有问题的。

**真正的行为改变依赖于设计你的生活方式，以避免消耗那些支撑意志的极度有限的资源。**